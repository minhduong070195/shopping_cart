                                ...
                                <div class="product-item">
                                    <div class="pi-pic">
                                        ...
                                        <ul>
                                            ...
                                            <li class="quick-view"><a onclick="addToCart({{$product->id}})" href="javascript:">+ Add Cart</a></li>
...
<script type="text/javascript">
    ...
    function addToCart(id) {
        $.ajax({
            ...
            if(res.success === true){
                if(res.link_login !== null){
                    window.location.href = res.link_login;
                }else{
                    renderCart(res.view_render);
    ...
    function changeFavoriteItem(id) {
        $.ajax({
            ...
            console.log(res);
            if(res.success === true){
                if(res.link_login !== null && res.link_login !== 'undefined'){
                    window.location.href = res.link_login;
                }else {
